...
public class CallLogsDBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "call_logs_db";
    public static final int DATABASE_VERSION = 1;
    private static final String TAG = "DB Helper";
    private static final String CALL_LOGS_LIMIT = "20";

    //Database Queries
    public static final String CREATE_TABLE = "CREATE TABLE " + CallLogsContract.CallLogsEntry.TABLE_NAME
    ...
    public static final String DROP_TABLE = "DROP TABLE IF EXISTS " + CallLogsContract.CallLogsEntry.TABLE_NAME;
    ...
    public Cursor showCallLogs(SQLiteDatabase sqLiteDatabase) {
        ...
        Cursor cursor = sqLiteDatabase.query(CallLogsContract.CallLogsEntry.TABLE_NAME,projections,null,null,null,null, CallLogsContract.CallLogsEntry.CALL_ID + " DESC",CALL_LOGS_LIMIT);
